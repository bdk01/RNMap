...
const HomeScreen = ({navigation}: any) => {
  ...
  const reverseGeoCode = async ({lat, long}: {lat: number; long: number}) => {
    const api = `https://revgeocode.search.hereapi.com/v1/revgeocode?at=${lat},${long}&lang=vi-VI&apiKey=b3sKuQEoPBXAOssGmomDJF9fpUmDH2yIv_9WWe_jZeY`;
    ...
    <View style={[globalStyles.container]}>
      ...
      <ScrollView
        ...
        style={[
          {
            flex: 1,
            marginTop: Platform.OS === 'ios' ? 22 : 34,
          },
        ]}>
